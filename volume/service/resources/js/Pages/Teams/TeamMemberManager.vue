    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                <template #title>
                    {{ $__('page.team:member:title') }}
                </template>

                <template #description>
                    {{ $__('page.team:member:description') }}
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ $__('page.team:member:form:explain') }}
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 lg:col-span-4" v-if="availableRoles.length > 0">
                        <jet-label for="roles" v-bind:value="$__('$.role')" />
        ...
        <div v-if="team.users.length > 0">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                <template #title>
                    {{ $__('page.team:members') }}
                </template>

                <template #description>
                    {{ $__('page.team:members:description') }}
                </template>
